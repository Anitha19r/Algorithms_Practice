/*
 * make array of 256 for all characters
 * insert the index no of the char in string into the array from start of string whenever u encounter a char 
 * if char repeats put -2
 * then take min positive index in the array u get the letter
 */
