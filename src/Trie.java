import java.util.*;
 ...
 /* Constructor */ 
	 ...
	 /* This function is used to insert a word in trie*/ public void insert(String word) {
	 ...
	 // If child not present, adding it io the list current.childList.add(new TrieNode(ch));
	 ...
	 /* This function is used to search a word in trie*/ public boolean search(String word) {
	 TrieNode current = root;
	 for (char ch : word.toCharArray() ) {
	 ...
	 /* This function is used to remove function from trie*/ public void remove(String word) {
	 ...
	 public static void printAllWordsInTrie(TrieNode root,String s) {
		 TrieNode current = root;
		 if(root.childList==null || root.childList.size()==0) return;
